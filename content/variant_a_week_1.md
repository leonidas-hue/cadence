# Variant A — Week 1: Foundations

**Profile:** Anxiety-Driven Acquired PE
**Week 1 theme:** *Slowing down the system.*
**Total sessions:** 7 (one per day)
**Average duration:** 5–8 minutes
**Voice direction:** Calm, measured, warm but not soft. Think "grounded older brother" rather than "wellness influencer." No vocal fry, no rising intonation at the end of statements. Consistent voice across all sessions — recommend ElevenLabs "Adam" or "Brian" as starting points.

---

## Audio script conventions used in this document

- `[PAUSE 3s]` — silence beats. ElevenLabs respects these literally.
- `[BREATH IN — 4s]` — paced cue, audio guides the breath.
- `[INHALE]` / `[EXHALE]` — short single-breath cues.
- `[soft]` / `[firmer]` — tone shift instructions for voice generation.
- `(stage direction)` — not voiced; for voice talent or AI direction reference.
...
**Goal:** Set the frame. Explain why anxiety drives PE and what we'll actually train.
...
Before we start any exercises, I want to tell you what we're actually doing here — because if you understand the why, the how becomes a lot easier.

[PAUSE 1s]

Your profile points to something specific. Acquired premature ejaculation, driven mostly by performance anxiety. That's a clinical-sounding phrase, but the reality is simpler than it sounds.
...
The second is parasympathetic — your rest-and-digest system. This is where slow, controlled, present sex actually lives. Heart rate down, breath deep, body relaxed, attention soft and wide.

[PAUSE 2s]

Most men with your profile spend their sexual experiences locked in sympathetic mode without realizing it. The whole problem can be reframed: it's not that you finish too fast. It's that your nervous system is in the wrong gear.

[PAUSE 2s]

[firmer]
So here's what we're going to train, over the next eight weeks.

[PAUSE 1s]

We're going to teach your body to access parasympathetic state on demand — including during sex. We'll use breath, attention, and gentle physical practices to do this. The pelvic floor work is light for your profile, because your floor probably isn't the problem.
...
Tomorrow we'll start with the foundation skill — extended exhale breathing. It takes five minutes, and it's the single most reliable lever you have for shifting nervous system state.

[PAUSE 2s]

That's it for today. Welcome aboard.
...
# Session 2 — "Extended exhale breathing"

**Day:** 2
**Duration:** ~7 min
**Type:** Practice (breathwork)
**Goal:** Teach extended exhale (4-in, 6-out) and complete one full set.

---

Today we learn the most important skill in the program. Extended exhale breathing.
...
This is the foundational skill. Everything else stacks on top of it. Tomorrow we'll do this again, longer, and add a small variation.
...
# Session 3 — "Body scan and the clench"

**Day:** 3
**Duration:** ~8 min
**Type:** Practice (body awareness)
**Goal:** Teach the user to notice unconscious tension. Especially around jaw, shoulders, glutes, pelvic floor.

---

Today we add something new. Body awareness.
...
The men who improve fastest learn to notice these tensions early — and release them. Today we practice the noticing.

[PAUSE 2s]

Lie down if you can. Otherwise sit with your back supported and your feet flat on the floor.

[PAUSE 3s]

Three rounds of extended exhale to settle in.
...
Now we scan. We move through the body slowly, noticing what's tense, and consciously letting it go.

[PAUSE 2s]

Start at the forehead. Notice if the muscles between your eyebrows are pulled together. Soften them.

[PAUSE 4s]

Move to the jaw. Most men carry significant tension here without knowing it. Let your tongue drop from the roof of your mouth. Let the teeth come slightly apart. Let the jaw hang.

[PAUSE 5s]

The shoulders. Notice if they're pulled up toward your ears. Drop them. Let them be heavy.

[PAUSE 4s]

The chest. Soften the breastbone. Let the breath move freely.

[PAUSE 4s]

The belly. Most men hold the belly in. Let it be soft. Let it round on the inhale.

[PAUSE 5s]

Now the glutes. Right now, are you clenching them? Many men do this constantly, especially under stress. Let them go completely soft.
...
Take three more easy breaths here, and notice the difference.
...
This is what unguarded feels like. Most of us walk around in low-level tension all day. The first step to changing it is feeling it.
...
Tomorrow we work on the cognitive side. The thoughts that generate the tension in the first place.
...
# Session 4 — "Spectatoring"

**Day:** 4
**Duration:** ~6 min
**Type:** Educational lesson with reflection prompt
**Goal:** Introduce the cognitive distortion of self-monitoring during sex.

---

Today we talk about something that almost every man with performance anxiety does — and almost none of us realize we're doing.

[PAUSE 2s]

Therapists call it spectatoring.
...
That's spectatoring. And here's the thing — the moment you spectate, two things happen.

[PAUSE 1s]

[firmer]
First, you leave your body. You stop feeling the actual sensations of sex. The pleasure becomes thinner, more abstract. It's harder to enjoy what's happening because you're not really there.
...
The cruel part: spectatoring usually starts because you're worried about finishing too fast. So the very act of trying to monitor your timing — accelerates your timing.
...
This is a skill. It's a muscle you have to build. And we're going to build it slowly over the next several weeks.
...
Tomorrow we return to breath, with a longer practice.
...
# Session 5 — "Box breathing"

**Day:** 5
**Duration:** ~8 min
**Type:** Practice (breathwork)
**Goal:** Add box breathing as a second tool. Used for grounding under acute pressure.
...
# Session 6 — "Light pelvic floor maintenance"

**Day:** 6
**Duration:** ~7 min
**Type:** Practice (PFM, light)
**Goal:** Establish PFM awareness without overemphasizing strength training. For Variant A, we want gentle, occasional contraction with full release — not a strength program.

---

Today, light pelvic floor work.
...
If you've ever consciously stopped your urine mid-stream, you've contracted the pelvic floor. Don't actually do that during urination as practice — it's bad for the bladder over time — but the sensation tells you where the muscle is.
...
Sit comfortably or lie on your back. Hand on belly. A few easy breaths to settle.
...
And release. Fully. Let it drop. Let it become heavy and soft.
...
Let's do five more, slowly. I'll guide you.
...
Tomorrow is a quiet day. Reflection. We close out week one and look at what comes next.
...
**Goal:** Consolidate week one. Set up week two.
...
Let's take a minute to look back at what you've actually built.
...
You've learned to scan the body for unconscious tension. Jaw, shoulders, glutes, floor. The noticing alone changes things.

[PAUSE 2s]

You've learned about spectatoring — and started to see it in your own experience.
...
A few things to know going into week two.

[PAUSE 1s]

[firmer]
First — we're going to start practicing during arousal. Solo work. We'll teach you to notice your arousal level on a one-to-ten scale, and to slow it down deliberately. This is where the breath training starts to pay off.
...
Third — if you have a partner, week three is when we start optionally bringing them into the work. Until then, this is your own thing. No pressure to involve anyone.

[PAUSE 2s]

[soft]
For today, one thing to do. Take five minutes — sometime today, whenever feels right — and do extended exhale breathing. Just for the practice. Just to feel it. No agenda.

[PAUSE 2s]

You showed up seven days in a row. That matters more than you think.

[PAUSE 2s]

See you tomorrow, in week two.
...
- [ ] Final-pass review of every script for tone and accuracy
- [ ] Generate audio for all 7 sessions in single ElevenLabs voice
- [ ] Verify all `[PAUSE]` and `[BREATH]` markers are honored
- [ ] Listen end-to-end at 1.0× and 1.25× playback to check pacing
- [ ] Spot-check on phone speaker and earbuds
- [ ] Add session metadata to JSON (id, duration_seconds, day, variant, type)
